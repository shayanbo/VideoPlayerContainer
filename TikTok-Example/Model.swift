...
let mockedVideos: [VideoData] = [
    VideoData(
        ...
        comments: [
            ...
            "I miss these uncommercialized non-esports days 🤒🥺",
    ...
    VideoData(
        ...
        comments: [
            ...
            "Super hype🔥🔥🔥 Boxer is really good",
        ]),
    VideoData(
        videoUrl: Bundle.main.path(forResource: "demo", ofType: "mp4")!,
        author: "Tommy",
    ...
    VideoData(
        ...
        comments: [
            ...
            "Wong no sabe hacer el especial de Balrgog,aqui yo ya soy mejor que él",
        ]),
    VideoData(
        videoUrl: Bundle.main.path(forResource: "demo", ofType: "mp4")!,
        author: "Tylor",
        ...
        comments: [
            ...
            "Lol shout so much in the end also lose 🤣",
        ]),
    VideoData(
        videoUrl: Bundle.main.path(forResource: "demo", ofType: "mp4")!,
        author: "Bob",
        ...
        comments: [
            ...
            "Justin wong didn’t even play boxer like that... just like the commentator said. IT WAS FOR THE CROWD",
        ]),
    VideoData(
        videoUrl: Bundle.main.path(forResource: "demo", ofType: "mp4")!,
        author: "Hans",
        ...
        comments: [
            "Daigo es más tranquilo en cambio  Justin  wong es muy agrandado  y farsante ahí se nota",
            "Hi I’m Daigo nice to meet you 😑",
            "I looked up the top 16 and we only have two Americans Idom and Justakid. Idom been putting the US on his back. Let’s see if it will carry into SF6!",
            "Daigo walk in 😑 Daigo wins a match 😑 Daigo lose 😑",
        ]),
]
